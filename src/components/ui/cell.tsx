export function PositionMetricCell({ position }: { position: number | string }) {
...
export function SentimentMetricCell({ sentiment }: { sentiment: number | string }) {
	...
	let dotClass = ""
	if (num >= 65) {
		bgClass = "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/55 dark:text-emerald-300"
		dotClass = "bg-emerald-500 dark:bg-emerald-400"
	} else if (num >= 40) {
		bgClass = "bg-amber-50 text-amber-700 dark:bg-amber-950/55 dark:text-amber-300"
