...
export async function runAnalysis(input: AnalysisInputSingle): Promise<BrandAnalysisResult> {
	...
	try {
		...
		throw new ValidationError("Invalid JSON returned from LLM during analysis.", {
