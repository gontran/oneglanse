...
export const protectedWorkspaceRoutes = {
	...
	listByOrg: protectedProcedure.input(listByOrgInputSchema).query(async ({ input, ctx }) => {
	...
	createInOrg: protectedProcedure.input(createInOrgInputSchema).mutation(async ({ input, ctx }) => {
