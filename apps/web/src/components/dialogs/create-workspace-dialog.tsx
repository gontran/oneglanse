...
export function CreateWorkspaceDialog({
	...
	return (
		<WorkspaceDialogShell
			...
			footerActions={
				<Button onClick={handleSubmit} disabled={loading} className={formPrimaryButtonClassName}>
		...
		>
			<div className="space-y-4">
				<div className="space-y-2">
					...
					/>
					<p className={formHintClassName}>Used as the tracked brand name in analysis.</p>
				</div>
				<div className="space-y-2">
