...
function handleProxyError(response: ServerResponse, statusCode: number, error: unknown): void {
...
function relaySockets(clientSocket: TrackedSocket, upstreamSocket: TrackedSocket): void {
	const destroyPair = () => {
