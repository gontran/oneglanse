...
async function findActiveEditorFromSelectors(page: Page, selectors: string[]): Promise<Locator> {
	const candidate = await findActiveEditorCandidateFromSelectors(page, selectors)
	return candidate.locator
}

async function findActiveEditor(page: Page, provider?: Provider): Promise<Locator> {
